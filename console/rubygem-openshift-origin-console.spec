...
%changelog
* Thu Dec 10 2015 Builder <getup@getupcloud.com> 1.26.3.2-106
...
- handle no payment (mateus.caruccio@getupcloud.com)

* Thu Nov 05 2015 Builder <getup@getupcloud.com> 1.26.3.2-105
- typo (mateus.caruccio@getupcloud.com)
- Merge branch 'getup-openshift-origin-release-4' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-4
  (mateus.caruccio@getupcloud.com)
- mesg on gear sizes for domains (mateus.caruccio@getupcloud.com)

* Thu Nov 05 2015 Builder <getup@getupcloud.com>
- Merge branch 'getup-openshift-origin-release-4' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-4
  (mateus.caruccio@getupcloud.com)
- mesg on gear sizes for domains (mateus.caruccio@getupcloud.com)

* Wed Aug 12 2015 Builder <getup@getupcloud.com> 1.26.3.2-27
- Merge branch 'getup-openshift-origin-release-4' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-4 (getup@getupcloud.com)
- Fix create first app button (mateus.caruccio@getupcloud.com)

* Mon Aug 03 2015 Builder <getup@getupcloud.com> 1.26.3.2-26
- Merge branch 'getup-openshift-origin-release-4' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-4 (getup@getupcloud.com)
- Desablita PayPal (mateus.caruccio@getupcloud.com)

* Fri Jul 24 2015 Builder <getup@getupcloud.com> 1.26.3.2-25
- Merge branch 'getup-openshift-origin-release-4' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-4 (getup@getupcloud.com)
- Fix use_primary_address form control (mateus.caruccio@getupcloud.com)

* Fri Jul 24 2015 Builder <getup@getupcloud.com> 1.26.3.2-24
- Merge branch 'getup-openshift-origin-release-4' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-4 (getup@getupcloud.com)
- Corrige endereco de billing (mateus.caruccio@getupcloud.com)

* Fri Jul 24 2015 Builder <getup@getupcloud.com> 1.26.3.2-23
- Merge branch 'getup-openshift-origin-release-4' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-4
  (mateus.caruccio@getupcloud.com)
- Melhorias nos links de doc e novas traducoes (mateus.caruccio@getupcloud.com)
- missing translations (mateus.caruccio@getupcloud.com)
- Always show pricing page link (mateus.caruccio@getupcloud.com)

* Fri Jul 10 2015 Builder <getup@getupcloud.com> 1.26.3.2-22
- Merge branch 'getup-openshift-origin-release-4' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-4 (getup@getupcloud.com)
- Always show pricing page link (mateus.caruccio@getupcloud.com)

* Fri Jul 10 2015 Builder <getup@getupcloud.com> 1.26.3.2-21
- Merge branch 'getup-openshift-origin-release-4' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-4 (getup@getupcloud.com)
- force utf-8 gemspec (mateus.caruccio@getupcloud.com)

* Fri Jul 10 2015 Builder <getup@getupcloud.com> 1.26.3.2-20
- 

* Fri Jul 10 2015 Builder <getup@getupcloud.com> 1.26.3.2-19
- 

* Fri Jul 10 2015 Builder <getup@getupcloud.com> 1.26.3.2-18
- Rebuild

* Fri Jul 10 2015 Builder <getup@getupcloud.com> 1.26.3.2-17
- Merge branch 'getup-openshift-origin-release-4' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-4
  (mateus.caruccio@getupcloud.com)
- Pagina de preços. (mateus.caruccio@getupcloud.com)
...
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- Login line (mateus.caruccio@getupcloud.com)

* Fri Jun 05 2015 Builder <getup@getupcloud.com> 1.26.3.1-18
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- Vertical signin fomr (mateus.caruccio@getupcloud.com)

* Fri Jun 05 2015 Builder <getup@getupcloud.com> 1.26.3.1-17
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- Download fonts from s3 (mateus.caruccio@getupcloud.com)

* Fri Jun 05 2015 Builder <getup@getupcloud.com> 1.26.3.1-16
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- missing import (mateus.caruccio@getupcloud.com)

* Fri Jun 05 2015 Builder <getup@getupcloud.com> 1.26.3.1-15
- rebuild

* Fri Jun 05 2015 Builder <getup@getupcloud.com>
- 

* Fri Jun 05 2015 Builder <getup@getupcloud.com> 1.26.3.1-14
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- Basic translations; Minor fixes; (mateus.caruccio@getupcloud.com)
- Our header and footer (mateus.caruccio@getupcloud.com)
- Better gear help text (mateus.caruccio@getupcloud.com)
- Remove PDF invoice; Minor css fixes (mateus.caruccio@getupcloud.com)
- Remove downloadable cart help link (mateus.caruccio@getupcloud.com)
- Customize App Create page (mateus.caruccio@getupcloud.com)
- Using radio instead select when creating scalable app
  (mateus.caruccio@getupcloud.com)

* Wed Jun 03 2015 Builder <getup@getupcloud.com> 1.26.3.1-13
- 

* Wed Jun 03 2015 Builder <getup@getupcloud.com> 1.26.3.1-12
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- Fix assets hell (mateus.caruccio@getupcloud.com)

* Tue Jun 02 2015 Builder <getup@getupcloud.com> 1.26.3.1-11
- 

* Tue Jun 02 2015 Builder <getup@getupcloud.com> 1.26.3.1-10
- 

* Tue Jun 02 2015 Builder <getup@getupcloud.com> 1.26.3.1-9
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- Missing respond_to? :helper_method (mateus.caruccio@getupcloud.com)

* Tue Jun 02 2015 Builder <getup@getupcloud.com> 1.26.3.1-8
- 

* Mon Jun 01 2015 Builder <getup@getupcloud.com> 1.26.3.1-7
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- Add console example config (mateus.caruccio@getupcloud.com)

* Mon Jun 01 2015 Builder <getup@getupcloud.com> 1.26.3.1-6
- 

* Mon Jun 01 2015 Builder <getup@getupcloud.com> 1.26.3.1-5
- Install missing gems

* Mon Jun 01 2015 Builder <getup@getupcloud.com> 1.26.3.1-4
- 
...
* Mon Jun 01 2015 Builder <getup@getupcloud.com>
- Pagamento com Cartao de Credito (mateus.caruccio@getupcloud.com)
- Initial porting getupcloud bits to v4 console
  (mateus.caruccio@getupcloud.com)
- Basic form login (mateus.caruccio@getupcloud.com)
