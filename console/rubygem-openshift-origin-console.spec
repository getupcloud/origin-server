...
%changelog
* Sun Jun 28 2015 Builder <getup@getupcloud.com> 1.26.3.1-7test
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- gettext rake only for non-production (mateus.caruccio@getupcloud.com)

* Sun Jun 28 2015 Builder <getup@getupcloud.com> 1.26.3.1-6test
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- update dep (mateus.caruccio@getupcloud.com)
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- console depends on haml 4.0 (mateus.caruccio@getupcloud.com)
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- Fix po load path (mateus.caruccio@getupcloud.com)
- Missing translations (mateus.caruccio@getupcloud.com)
- Translate auth error/session expire mesgs (mateus.caruccio@getupcloud.com)

* Fri Jun 26 2015 Builder <getup@getupcloud.com> 1.26.3.1-5test
- 

* Fri Jun 26 2015 Builder <getup@getupcloud.com>
- 

* Fri Jun 26 2015 Builder <getup@getupcloud.com> 1.26.3.1-4test
- 

* Fri Jun 26 2015 Builder <getup@getupcloud.com> 1.26.3.1-3test
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- dont need some deps to build (mateus.caruccio@getupcloud.com)

* Fri Jun 26 2015 Builder <getup@getupcloud.com> 1.26.3.1-2test
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- missing deps (mateus.caruccio@getupcloud.com)

* Fri Jun 26 2015 Builder <getup@getupcloud.com> 1.26.3.1-1test
