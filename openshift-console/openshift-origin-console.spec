...
%changelog
* Sun Jun 28 2015 Builder <getup@getupcloud.com> 1.16.2.1-8getup
- 

* Sun Jun 28 2015 Builder <getup@getupcloud.com> 1.16.2.1-7getup
...
* Sun Jun 28 2015 Builder <getup@getupcloud.com> 1.16.2.1-6getup
- 

* Sun Jun 28 2015 Builder <getup@getupcloud.com> 1.16.2.1-5getup
- 

* Sun Jun 28 2015 Builder <getup@getupcloud.com> 1.16.2.1-4getup
- 
...
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- openshift-console: missing gem deps (mateus.caruccio@getupcloud.com)

* Sat Jun 27 2015 Builder <getup@getupcloud.com> 1.16.2.1-1getup
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- Fix po load path (mateus.caruccio@getupcloud.com)

* Fri Jun 26 2015 Builder <getup@getupcloud.com> 1.16.2.1-10test
- 

* Fri Jun 05 2015 Builder <getup@getupcloud.com> 1.16.2.1-9
- rebuild

* Fri Jun 05 2015 Builder <getup@getupcloud.com> 1.16.2.1-8
- rebuild

* Fri Jun 05 2015 Builder <getup@getupcloud.com> 1.16.2.1-7
- rebuild

* Fri Jun 05 2015 Builder <getup@getupcloud.com> 1.16.2.1-6
- rebuild

* Wed Jun 03 2015 Builder <getup@getupcloud.com> 1.16.2.1-5
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- typo (mateus.caruccio@getupcloud.com)

* Wed Jun 03 2015 Builder <getup@getupcloud.com> 1.16.2.1-4
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- Fix assets hell (mateus.caruccio@getupcloud.com)

* Tue Jun 02 2015 Builder <getup@getupcloud.com> 1.16.2.1-3
- Merge branch 'console-r4' of github.com:getupcloud/origin-server into
  console-r4 (getup@getupcloud.com)
- default console app config (mateus.caruccio@getupcloud.com)
