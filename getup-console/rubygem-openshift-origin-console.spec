...
%changelog
* Thu Feb 12 2015 Builder <getup@getupcloud.com> 1.7.6-104
...
- Remove Due Date from invoice listing (mateus.caruccio@getupcloud.com)
- Create NodeJS app type group (mateus.caruccio@getupcloud.com)

* Wed Dec 10 2014 Builder <getup@getupcloud.com> 1.7.6-101
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- missing coin border css attrs (mateus.caruccio@getupcloud.com)

* Wed Dec 10 2014 Builder <getup@getupcloud.com> 1.7.6-100
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- border usage rate icon (mateus.caruccio@getupcloud.com)

* Wed Dec 10 2014 Builder <getup@getupcloud.com> 1.7.6-99
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- Display usage rates symbol (mateus.caruccio@getupcloud.com)

* Tue Dec 09 2014 Builder <getup@getupcloud.com> 1.7.6-98
- 

* Wed Nov 26 2014 Builder <getup@getupcloud.com> 1.7.6-97
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- Bill display wrong values (mateus.caruccio@getupcloud.com)

* Mon Nov 10 2014 Builder <getup@getupcloud.com> 1.7.6-96
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- missing translation for non payment (mateus.caruccio@getupcloud.com)

* Thu Nov 06 2014 Builder <getup@getupcloud.com> 1.7.6-95
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- dont break on flash failure (app create) (mateus.caruccio@getupcloud.com)

* Thu Nov 06 2014 Builder <getup@getupcloud.com> 1.7.6-94
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- dont break on flash failure (mateus.caruccio@getupcloud.com)

* Wed Nov 05 2014 Builder <getup@getupcloud.com> 1.7.6-93
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- minor fix (mateus.caruccio@getupcloud.com)

* Wed Nov 05 2014 Builder <getup@getupcloud.com> 1.7.6-92
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3
  (mateus.caruccio@getupcloud.com)
- Account show trial end message (mateus.caruccio@getupcloud.com)

* Tue Nov 04 2014 Builder <getup@getupcloud.com> 1.7.6-91
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fix bil precision (mateus.caruccio@getupcloud.com)

* Tue Nov 04 2014 Builder <getup@getupcloud.com> 1.7.6-90
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3
  (mateus.caruccio@getupcloud.com)
- fix credits (mateus.caruccio@getupcloud.com)

* Tue Nov 04 2014 Builder <getup@getupcloud.com> 1.7.6-89
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fix voucher load (mateus.caruccio@getupcloud.com)

* Tue Nov 04 2014 Builder <getup@getupcloud.com> 1.7.6-88
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- supress empty services (mateus.caruccio@getupcloud.com)

* Tue Nov 04 2014 Builder <getup@getupcloud.com> 1.7.6-87
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- Fix bill (mateus.caruccio@getupcloud.com)

* Thu Oct 30 2014 Builder <getup@getupcloud.com> 1.7.6-86
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fix credit table filter (mateus.caruccio@getupcloud.com)

* Thu Oct 30 2014 Builder <getup@getupcloud.com> 1.7.6-85
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- minor change (mateus.caruccio@getupcloud.com)
- Show credits on my account (mateus.caruccio@getupcloud.com)

* Tue Oct 28 2014 Builder <getup@getupcloud.com> 1.7.6-84
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- better unlock acct flash mesg (mateus.caruccio@getupcloud.com)
...
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fix credit filter (mateus.caruccio@getupcloud.com)
- authorization title (mateus.caruccio@getupcloud.com)

* Tue Oct 28 2014 Builder <getup@getupcloud.com> 1.7.6-81
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- minor fix (mateus.caruccio@getupcloud.com)

* Tue Oct 28 2014 Builder <getup@getupcloud.com> 1.7.6-80
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- export getup_credit_url to view (mateus.caruccio@getupcloud.com)
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- minor fix (mateus.caruccio@getupcloud.com)

* Tue Oct 28 2014 Builder <getup@getupcloud.com>
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- minor fix (mateus.caruccio@getupcloud.com)

* Tue Oct 28 2014 Builder <getup@getupcloud.com> 1.7.6-79
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- credit table help (mateus.caruccio@getupcloud.com)

* Tue Oct 28 2014 Builder <getup@getupcloud.com> 1.7.6-78
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- integer free tier (mateus.caruccio@getupcloud.com)

* Tue Oct 28 2014 Builder <getup@getupcloud.com> 1.7.6-77
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fix credit table (mateus.caruccio@getupcloud.com)

* Mon Oct 27 2014 Builder <getup@getupcloud.com> 1.7.6-76
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fix credit table (mateus.caruccio@getupcloud.com)

* Mon Oct 27 2014 Builder <getup@getupcloud.com> 1.7.6-75
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fix credit template (mateus.caruccio@getupcloud.com)

* Mon Oct 27 2014 Builder <getup@getupcloud.com> 1.7.6-74
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- My Account show credits (mateus.caruccio@getupcloud.com)

* Mon Oct 27 2014 Builder <getup@getupcloud.com> 1.7.6-73
- 

* Thu Jul 24 2014 Builder <getup@getupcloud.com> 1.7.6-72
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fiz gears help text (mateus.caruccio@getupcloud.com)
- Add medium-br (mateus.caruccio@getupcloud.com)

* Thu Jul 24 2014 Builder <getup@getupcloud.com> 1.7.6-71
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fix gear help mesg (mateus.caruccio@getupcloud.com)

* Thu Jul 24 2014 Builder <getup@getupcloud.com> 1.7.6-70
- bump version 

* Thu Jul 24 2014 Builder <getup@getupcloud.com> 1.7.6-69
- Custo gear/hora (mateus.caruccio@getupcloud.com)
- typo (mateus.caruccio@getupcloud.com)

* Fri Jul 04 2014 Builder <getup@getupcloud.com> 1.7.6-68
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- typo (mateus.caruccio@getupcloud.com)
- reverse billing history (mateus.caruccio@getupcloud.com)

* Thu Jun 26 2014 Builder <getup@getupcloud.com> 1.7.6-67
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fix storage price (mateus.caruccio@getupcloud.com)

* Wed Jun 25 2014 Builder <getup@getupcloud.com> 1.7.6-66
- Translate welcome pages to pt-br

* Tue Jun 24 2014 Builder <getup@getupcloud.com> 1.7.6-65
- bump version (spinolacastro@gmail.com)
- redirect from old url /account/gears (mateus.caruccio@getupcloud.com)
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- Suporta billing antigos (mateus.caruccio@getupcloud.com)
- fix invoice (mateus.caruccio@getupcloud.com)

* Fri Jun 20 2014 Builder <getup@getupcloud.com> 1.7.6-63
- Invoice for billing types (mateus.caruccio@getupcloud.com)
...
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- fix precompile userinfo bug (mateus.caruccio@getupcloud.com)

* Tue Apr 01 2014 Builder <getup@getupcloud.com> 1.7.6-47
- version bump

* Tue Apr 01 2014 Builder <getup@getupcloud.com> 1.7.6-46
- version bump
...
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3 (getup@getupcloud.com)
- Validate CPF/CNPJ (mateus.caruccio@getupcloud.com)
...
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3
  (root@mirror.ops.getupcloud.com)
- correcoes de traducao (mateus.caruccio@getupcloud.com)
- fix translations (mateus.caruccio@getupcloud.com)
- added skeuocard assets (mateus.caruccio@getupcloud.com)

* Sat Feb 22 2014 Unknown name 1.7.6-18
...
- Merge branch 'getup-openshift-origin-release-3' of github.com:getupcloud
  /origin-server into getup-openshift-origin-release-3
  (mateus.caruccio@getupcloud.com)
- no enforce valid locale (mateus.caruccio@getupcloud.com)
...
* Mon Oct 07 2013 Getup Builder <getup@getupcloud.com>
- Add Gears translations (mateus@caruccio.com)

* Wed Oct 02 2013 Getup Builder <getup@getupcloud.com> 1.7.6-7
- Removed User Guide links (mateus@caruccio.com)
